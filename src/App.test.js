...
describe('List', () => {
    ...
    test('renders the list with its link information', () => {
        render(<List {...listProps} />);
        expect(screen.getByText('react', {exact: false})).toBeInTheDocument();
        expect(screen.getByText('redux', {exact: false})).toBeInTheDocument();
    });
...
describe('InputWithLabel', () => {
    ...
    test('renders the story with information', () => {
...
describe('App', () => {
    ...
    test('removes a story', async () => {
        ...
        expect(screen.queryByText('Jordan Walk')).toBeNull();
    });
